...
if __name__ == "__main__":
    ...
    parser.add_argument('-i', '--input', help="Input samples list (TSV: Filename\tResults Path\n)")
                                        ...
                                        for transcript_dict in var_dict['transcripts']:
                                            if transcript_dict['transcript'].startswith("ENST"):
                                                ...
                                                if germline_rare:
                                                    ...
                                                    if 'cosmic' in var_dict:germline_rare = True
                                                if 'gnomad' in var_dict:
                                                    if var_dict['gnomad']['allAf'] >= 0.005:
                                                        germline_rare = False
                                                if germline_rare:
                                                    ...
                                                    if 'cosmic' in var_dict:
                                                        ...
                                                        outfile.write(f"{','.join([str(i) for i in sample_counts])}\t")
                                                    else:
                                                        outfile.write("-\t")
                                                        # outfile.write("-\t")
